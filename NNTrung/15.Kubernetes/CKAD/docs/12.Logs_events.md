...
![altimage](../images/fae60444184ca7bd8c3698d866c24617.png)

### Diagram pod logs và events flow, minh họa cách events liên kết với logs cho observability

![altimage](../images/k8s-logging-1.gif)

## References
[Reference](https://devops.vn/posts/bai-10-giam-sat-log-va-events-voi-kubectl-logs/)
