...
![altimage](../images/1_434lLmJgDQEmSE0pt2TX2A.png)
...
![altimage](../images/sealed_secrets_flow.png)

## 2. Cách tạo ConfigMap và Secret trong YAML
...
## 3. Mount ConfigMap/Secret vào Pod trong YAML
### 3.1 Mount làm Env
```yaml
apiVersion: v1
kind: Pod
