...
Trong đó: 
  ...
  - **TTL(Time to live)**: thời gian tồn tại của bản ghi trong cache, hết hạn thì phải hỏi lại.

### 2. Các loại bản ghi (Type) chính
#### 2.1 Bản ghi A (A Record)
...
#### 2.2 Bản ghi CN (Canonical Name Record)
...
#### 2.3 Bản ghi AAAA (IPv6 Address Record)
...
#### 2.4 Bản ghi MX (Mail Exchange Record)
...
### 2.7 NS Record (NameServer Record)
