...
Quy trình được chia thành 5 giai đoạn chính:
...
1. **Xác thực người dùng qua Keystone**  
   ...
   - Từ unscope token Client chọn project mục tiêu và request scoped token để làm việc với các service trong project đó
