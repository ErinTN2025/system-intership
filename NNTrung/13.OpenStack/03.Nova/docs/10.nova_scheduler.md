...
#### Giải thích
- Tại sao ta nên chú ý đoạn này:
  - Hãy tưởng tượng bạn có 4 máy: Compute 1, 2, 3, 4
  - Bạn muốn tạo VM, cách đơn giản nhất nói thẳng cho tôi Availability zone này...
  - Nhưng vấn đề là sau này Admin đổi tên AZ-SSD thành 1 cái j đó khác
  - Bạn cũng phải sửa lại configuration gọi là hard-code AZ
  - Cách khác tạo flavor extra specs ghi hết các yêu cầu vào trong đó.
  - Lúc tạo VM Nova sẽ nhìn và chọn ra host phù hợp với yêu cầu flavor
  - Host Aggregate chính là cách admin gom những máy có cùng đặc điểm vào một nhóm.
