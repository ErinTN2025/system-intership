...
File cấu hình chính của Nova truyền thống mặc định nằm tại đường dẫn:  
`/etc/nova/nova.conf`
...
File cấu hình chính của Nova Kolla Ansible vị trí 
`/etc/kolla`

![altimage](../images/Screenshot_14.png)

- Kolla Ansible containerize từng service riêng, rồi mount vào container.
